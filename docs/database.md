...
| 0009 | `source_documents.metadata jsonb` (parser-recorded facts, incl. integrity findings in the source); uniqueness becomes (snapshot, locator, parser_version) so a snapshot can be re-parsed by a newer parser with the earlier documents kept                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | –           |
